...
- [template-development-testing.md](template-development-testing.md) - Testing and contributing
- [team-development-alignment.md](team-development-alignment.md) - Consistency practices